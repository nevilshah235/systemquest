...
export const MISSION_SOLUTIONS: Record<string, MissionSolution> = {
  ...
  'live-scoreboard': {
    architecture: {
      components: [
        { id: 'sol-client',     type: 'web-client',        x: 300, y: 40  },
        { id: 'sol-ws',         type: 'websocket-server',  x: 580, y: 40  },
        { id: 'sol-apigw',      type: 'api-gateway',       x: 300, y: 160 },
        { id: 'sol-lb',         type: 'load-balancer-l7',  x: 300, y: 280 },
        { id: 'sol-server1',    type: 'app-server',        x: 80,  y: 400 },
        { id: 'sol-server2',    type: 'app-server',        x: 300, y: 400 },
        { id: 'sol-server3',    type: 'app-server',        x: 520, y: 400 },
        { id: 'sol-monitoring', type: 'logging-service',   x: 700, y: 400 },
        { id: 'sol-pubsub',     type: 'pub-sub',           x: 140, y: 520 },
        { id: 'sol-kv',         type: 'key-value-store',   x: 420, y: 520 },
        { id: 'sol-db',         type: 'relational-db',     x: 280, y: 640 },
      ],
      connections: [
        { id: 'sc1',  from: 'sol-client',  to: 'sol-apigw'   },
        { id: 'sc2',  from: 'sol-client',  to: 'sol-ws'      },
        { id: 'sc3',  from: 'sol-apigw',   to: 'sol-lb'      },
        { id: 'sc4',  from: 'sol-lb',      to: 'sol-server1' },
        { id: 'sc5',  from: 'sol-lb',      to: 'sol-server2' },
        { id: 'sc6',  from: 'sol-lb',      to: 'sol-server3' },
        { id: 'sc7',  from: 'sol-server1', to: 'sol-pubsub'  },
        { id: 'sc8',  from: 'sol-server2', to: 'sol-kv'      },
        { id: 'sc9',  from: 'sol-server3', to: 'sol-kv'      },
        { id: 'sc10', from: 'sol-pubsub',  to: 'sol-ws'      },
        { id: 'sc11', from: 'sol-kv',      to: 'sol-db'      },
        { id: 'sc12', from: 'sol-pubsub',  to: 'sol-db'      },
        { id: 'sc13', from: 'sol-monitoring', to: 'sol-server1' },
        { id: 'sc14', from: 'sol-monitoring', to: 'sol-server2' },
        { id: 'sc15', from: 'sol-monitoring', to: 'sol-server3' },
      ],
    ...
    steps: [
      'Client → API Gateway (REST) + WebSocket Server (real-time score updates)',
      'Load Balancer → 3 App Servers: update servers publish to Pub/Sub; read servers query Key-Value Store',
      'Pub/Sub broadcasts score updates to WebSocket Server for real-time push to 80k viewers',
      'Key-Value Store (Redis Sorted Sets) stores live scores — sub-10ms reads, no DB queries',
      'Database persists match history; Logging tracks update lag and WebSocket connection health',
    ],
    explanation:
      'A live scoreboard with 80,000 concurrent viewers requires WebSocket for real-time push and a Key-Value Store for fast reads. Three App Servers handle updates and reads: update servers publish score changes to Pub/Sub, which broadcasts to WebSocket Server for instant push. Read servers query the Key-Value Store (Redis Sorted Sets) for leaderboards in <10ms. The Database stores match history. Logging tracks update lag and connection health.',
  },
  ...
  'search-engine': {
    architecture: {
      components: [
        ...
        { id: 'sol-server1',    type: 'app-server',      x: 80,  y: 400 },
        { id: 'sol-server2',    type: 'app-server',      x: 300, y: 400 },
        { id: 'sol-worker',     type: 'worker',          x: 520, y: 400 },
        { id: 'sol-monitoring', type: 'logging-service', x: 700, y: 400 },
        { id: 'sol-cache',      type: 'redis-cache',     x: 80,  y: 520 },
        { id: 'sol-search',     type: 'search-engine',   x: 300, y: 520 },
        { id: 'sol-storage',    type: 'object-storage',  x: 520, y: 520 },
        { id: 'sol-db',         type: 'relational-db',   x: 300, y: 640 },
      ],
      connections: [
        { id: 'sc1',  from: 'sol-client',  to: 'sol-apigw'   },
        { id: 'sc2',  from: 'sol-client',  to: 'sol-cdn'     },
        ...
        { id: 'sc7',  from: 'sol-server2', to: 'sol-search'  },
        { id: 'sc8',  from: 'sol-worker',  to: 'sol-search'  },
        { id: 'sc9',  from: 'sol-worker',  to: 'sol-storage' },
        { id: 'sc10', from: 'sol-cache',   to: 'sol-search'  },
        { id: 'sc11', from: 'sol-search',  to: 'sol-db'      },
        { id: 'sc12', from: 'sol-storage', to: 'sol-db'      },
        { id: 'sc13', from: 'sol-monitoring', to: 'sol-server1' },
        { id: 'sc14', from: 'sol-monitoring', to: 'sol-server2' },
        { id: 'sc15', from: 'sol-monitoring', to: 'sol-worker' },
      ],
    },
    steps: [
      'Client → API Gateway + CDN (serve autocomplete and static search UI at the edge)',
      'Load Balancer → 2 App Servers: query servers read from Elasticsearch via Cache',
      'Elasticsearch stores inverted index for full-text search across billions of documents',
      'Worker crawls and indexes web pages, writing to Elasticsearch and Object Storage',
      'Cache serves top-1000 queries in memory — eliminates repeated Elasticsearch queries',
    ],
    explanation:
      'Search requires Elasticsearch for full-text indexing and ranking. Query servers read from Elasticsearch (via Cache for hot queries) to serve 75k concurrent searches at 135ms. A Worker continuously crawls the web, indexes pages into Elasticsearch, and stores raw HTML in Object Storage. The Database stores document metadata and crawl state. CDN accelerates autocomplete, and Logging tracks query latency and index freshness.',
  },
  ...
  'social-feed': {
    architecture: {
      components: [
        { id: 'sol-client',     type: 'web-client',        x: 300, y: 30  },
        { id: 'sol-cdn',        type: 'cdn',               x: 580, y: 30  },
        { id: 'sol-apigw',      type: 'api-gateway',       x: 300, y: 140 },
        { id: 'sol-lb',         type: 'load-balancer-l7',  x: 300, y: 260 },
        { id: 'sol-server1',    type: 'app-server',        x: 40,  y: 380 },
        { id: 'sol-server2',    type: 'app-server',        x: 180, y: 380 },
        { id: 'sol-server3',    type: 'app-server',        x: 420, y: 380 },
        { id: 'sol-worker',     type: 'worker',            x: 560, y: 380 },
        { id: 'sol-monitoring', type: 'logging-service',   x: 720, y: 380 },
        { id: 'sol-cache',      type: 'redis-cache',       x: 80,  y: 500 },
        { id: 'sol-stream',     type: 'event-stream',      x: 300, y: 500 },
        { id: 'sol-storage',    type: 'object-storage',    x: 500, y: 500 },
        { id: 'sol-db',         type: 'wide-column-store', x: 190, y: 620 },
      ],
      connections: [
        { id: 'sc1',  from: 'sol-client',  to: 'sol-apigw'   },
        { id: 'sc2',  from: 'sol-client',  to: 'sol-cdn'     },
        ...
        { id: 'sc7',  from: 'sol-server1', to: 'sol-cache'   },
        { id: 'sc8',  from: 'sol-server2', to: 'sol-cache'   },
        { id: 'sc9',  from: 'sol-server3', to: 'sol-stream'  },
        { id: 'sc10', from: 'sol-worker',  to: 'sol-stream'  },
        { id: 'sc11', from: 'sol-worker',  to: 'sol-storage' },
        { id: 'sc12', from: 'sol-cache',   to: 'sol-db'      },
        { id: 'sc13', from: 'sol-stream',  to: 'sol-db'      },
        ...
        { id: 'sc18', from: 'sol-monitoring', to: 'sol-worker' },
      ],
    },
    steps: [
      'Client → API Gateway + CDN (media delivery at edge); 3 App Servers behind Load Balancer',
      'Post events published to Event Stream (Kafka) — Workers consume and fan-out to follower timelines',
      'Feed readers pull pre-computed timelines from Cache — never from Cassandra directly',
      'Wide-Column Store (Cassandra) stores user timelines optimized for high-write fan-out',
      'Media uploads go to Object Storage; CDN serves images/videos from Storage at edge',
    ],
    explanation:
      "Fan-out on write is the key pattern: when a user posts, the Event Stream (Kafka) broadcasts the event to Workers that pre-write the post into each follower's timeline in Cassandra. Feed readers get sub-160ms responses because they only read from Cache. Three App Servers handle 500k concurrent readers. Cassandra's wide-column model excels at timeline writes. CDN + Object Storage deliver media without touching app servers, and Logging watches fan-out lag for viral posts.",
  },
  ...
  'ride-hailing': {
    architecture: {
      components: [
        { id: 'sol-client',     type: 'mobile-client',     x: 300, y: 40  },
        { id: 'sol-cdn',        type: 'cdn',               x: 580, y: 40  },
        { id: 'sol-apigw',      type: 'api-gateway',       x: 300, y: 160 },
        { id: 'sol-ws',         type: 'websocket-server',  x: 580, y: 160 },
        { id: 'sol-lb',         type: 'load-balancer-l7',  x: 300, y: 280 },
        { id: 'sol-server1',    type: 'app-server',        x: 80,  y: 400 },
        { id: 'sol-server2',    type: 'app-server',        x: 300, y: 400 },
        { id: 'sol-server3',    type: 'app-server',        x: 520, y: 400 },
        { id: 'sol-monitoring', type: 'logging-service',   x: 700, y: 400 },
        { id: 'sol-geo',        type: 'geospatial-index',  x: 140, y: 520 },
        { id: 'sol-pubsub',     type: 'pub-sub',           x: 420, y: 520 },
        { id: 'sol-db',         type: 'relational-db',     x: 280, y: 640 },
      ],
      connections: [
        { id: 'sc1',  from: 'sol-client',  to: 'sol-apigw'   },
        { id: 'sc2',  from: 'sol-client',  to: 'sol-ws'      },
        { id: 'sc3',  from: 'sol-client',  to: 'sol-cdn'     },
        { id: 'sc4',  from: 'sol-apigw',   to: 'sol-lb'      },
        { id: 'sc5',  from: 'sol-lb',      to: 'sol-server1' },
        { id: 'sc6',  from: 'sol-lb',      to: 'sol-server2' },
        { id: 'sc7',  from: 'sol-lb',      to: 'sol-server3' },
        { id: 'sc8',  from: 'sol-server1', to: 'sol-geo'     },
        { id: 'sc9',  from: 'sol-server2', to: 'sol-geo'     },
        { id: 'sc10', from: 'sol-server3', to: 'sol-pubsub'  },
        { id: 'sc11', from: 'sol-ws',      to: 'sol-pubsub'  },
        { id: 'sc12', from: 'sol-geo',     to: 'sol-db'      },
        { id: 'sc13', from: 'sol-pubsub',  to: 'sol-db'      },
    ...
    steps: [
      'Mobile Client → API Gateway (REST) + WebSocket Server (real-time location streams)',
      'Load Balancer → 3 App Servers: location servers write to Geospatial Index; match servers query it',
      'Geospatial Index (H3/Quadtree) stores live driver GPS — enables sub-50ms "nearby drivers" queries',
      'Pub/Sub broadcasts driver location updates to riders in real-time via WebSocket',
      'Database persists trip records; CDN serves map tiles at edge; Logging tracks match latency',
    ],
    explanation:
      'Real-time driver matching requires a Geospatial Index for efficient radius queries. Three App Servers handle location updates and ride requests: location servers write driver coordinates to the Geospatial Index every 3s, and matching servers query nearby drivers in <50ms. Pub/Sub + WebSocket push live location updates to riders. The Database stores trip history. CDN serves map tiles at the edge, and API Gateway manages REST traffic while WebSocket Server handles bidirectional streams.',
  },
  ...
  'video-streaming': {
    architecture: {
      components: [
        ...
        { id: 'sol-server1',    type: 'app-server',      x: 40,  y: 380 },
        { id: 'sol-server2',    type: 'app-server',      x: 180, y: 380 },
        { id: 'sol-transcoder', type: 'transcoder',      x: 420, y: 380 },
        { id: 'sol-worker',     type: 'worker',          x: 560, y: 380 },
        { id: 'sol-monitoring', type: 'logging-service', x: 720, y: 380 },
        { id: 'sol-cache',      type: 'redis-cache',     x: 80,  y: 500 },
        { id: 'sol-stream',     type: 'event-stream',    x: 300, y: 500 },
        { id: 'sol-storage',    type: 'object-storage',  x: 500, y: 500 },
        { id: 'sol-db',         type: 'relational-db',   x: 190, y: 620 },
      ],
      connections: [
        { id: 'sc1',  from: 'sol-client',  to: 'sol-apigw'      },
        { id: 'sc2',  from: 'sol-client',  to: 'sol-cdn'        },
        ...
        { id: 'sc5',  from: 'sol-lb',      to: 'sol-server2'    },
        { id: 'sc6',  from: 'sol-server1', to: 'sol-cache'      },
        { id: 'sc7',  from: 'sol-server2', to: 'sol-cache'      },
        { id: 'sc8',  from: 'sol-server1', to: 'sol-stream'     },
        { id: 'sc9',  from: 'sol-worker',  to: 'sol-stream'     },
        { id: 'sc10', from: 'sol-worker',  to: 'sol-transcoder' },
        { id: 'sc11', from: 'sol-transcoder', to: 'sol-storage' },
        { id: 'sc12', from: 'sol-cache',   to: 'sol-db'         },
        { id: 'sc13', from: 'sol-stream',  to: 'sol-db'         },
        { id: 'sc14', from: 'sol-cdn',     to: 'sol-storage'    },
        { id: 'sc15', from: 'sol-monitoring', to: 'sol-server1' },
        { id: 'sc16', from: 'sol-monitoring', to: 'sol-server2' },
        { id: 'sc17', from: 'sol-monitoring', to: 'sol-worker'  },
      ],
    },
    steps: [
      'Client → CDN: video bytes MUST come from CDN edge — never directly from origin',
      'API Gateway + Load Balancer route metadata and session requests to 2 App Servers',
      'Cache stores video metadata, watch progress, and personalized recommendations',
      'Event Stream triggers async transcoding: Worker consumes upload events and sends to Transcoder',
      'Transcoder generates 480p, 720p, 1080p, 4K renditions; writes to Object Storage; CDN pulls from Storage',
    ],
    explanation:
      'Video streaming at 500k concurrent viewers requires CDN edge nodes to serve video bytes — origin servers handle only metadata. Two App Servers process session requests. Cache serves metadata in memory. Event Stream decouples uploads from transcoding: Workers consume upload events and send raw video to the Transcoder, which generates multiple renditions and writes to Object Storage. CDN pre-warms popular titles at the edge. Logging tracks playback quality and transcoding lag.',
  },
