// Concept taxonomy for the On-Demand Concept Advisor (F-001)
...
export const CONCEPTS: Concept[] = [
  ...
  // ── Intermediate ──────────────────────────────────────────────────────────────
  {
    ...
    relatedMissions: ['file-converter', 'code-judge', 'live-scoreboard'],
  ...
  },
  {
    ...
    emoji: '🔺',
    difficulty: 'intermediate',
    relatedMissions: ['booking-system', 'payment-processing', 'search-engine'],
  ...
  },
  {
    ...
    emoji: '🔀',
    difficulty: 'intermediate',
    relatedMissions: ['social-feed', 'url-shortener', 'search-engine'],
  ...
  },
  {
    ...
    emoji: '🔀',
    difficulty: 'intermediate',
    relatedMissions: ['file-converter', 'ride-hailing', 'booking-system'],
  ...
  },
  {
    ...
    emoji: '🔄',
    difficulty: 'intermediate',
    relatedMissions: ['url-shortener', 'social-feed'],
    relatedPaths: ['high-read', 'scale-streaming'],
  },
  // ── Advanced ──────────────────────────────────────────────────────────────────
  {
  ...
  },
  {
    ...
    emoji: '🎯',
    difficulty: 'advanced',
    relatedMissions: ['payment-processing'],
    relatedPaths: ['consistency'],
  },
  {
    ...
    emoji: '⚡',
    difficulty: 'advanced',
    relatedMissions: ['social-feed', 'ride-hailing', 'live-scoreboard'],
  ...
  },
  {
    ...
    emoji: '🤝',
    difficulty: 'advanced',
    relatedMissions: ['payment-processing', 'booking-system'],
    relatedPaths: ['consistency'],
  },
  {
    slug: 'rate-limiting',
    ...
    emoji: '🚦',
    difficulty: 'intermediate',
    relatedMissions: ['url-shortener', 'booking-system'],
  ...
  },
  {
    ...
    emoji: '💾',
    difficulty: 'intermediate',
    relatedMissions: ['file-converter', 'video-streaming', 'social-feed'],
  ...
  },
  {
    ...
    emoji: '🔧',
    difficulty: 'advanced',
    relatedMissions: ['global-expansion', 'payment-processing'],
